...
<div class="container">
  ...
  <div class="card">
    <h2>Reactivar tu cuenta</h2>
    <p>Hola {{ $user->name }}, recibimos una solicitud para reactivar tu cuenta en Noctua. Hace click en el botón para volver a activarla.</p>
    <p style="margin:0">Este enlace expira en <strong style="color:#fff">24 horas</strong>.</p>
    <a href="{{ $reactivateUrl }}" class="btn">Reactivar mi cuenta</a>
  </div>
