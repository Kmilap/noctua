...
<title>Reactivá tu cuenta de Noctua</title>
</head>
...
@php
  $lastLoginLabel = $user->last_login_at
    ? \Carbon\Carbon::parse($user->last_login_at)->locale('es')->diffForHumans()
    : 'hace un tiempo';
@endphp

<div style="display: none; max-height: 0; overflow: hidden; mso-hide: all;">
Tu cuenta de Noctua está inactiva. Reactivala en un click.
</div>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
              ...
              <tr>
                <td style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 1.6; color: #9ca3af; padding: 0 0 28px 0;">
                  Tu cuenta está inactiva desde hace un tiempo. Tus servicios y reglas siguen guardados &mdash; solo necesitás reactivarla para seguir monitoreando.
                </td>
              </tr>
              ...
              <tr>
                <td style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 1.6; color: #9ca3af; padding: 0 0 40px 0;">
                  Este enlace de reactivación expira en <span style="color: #ffffff; font-weight: 700;">7 días</span>. Si ya no querés usar Noctua, podés ignorar este correo y tu cuenta se eliminará automáticamente.
                </td>
              </tr>
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td align="center" bgcolor="#ef9f27" style="background-color: #ef9f27; border-radius: 12px;">
                        <a href="{{ $reactivateUrl }}" target="_blank" style="display: block; padding: 18px 32px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 700; color: #0f0e17; text-decoration: none; border-radius: 12px; letter-spacing: -0.01em;">
                          Reactivar mi cuenta
                        </a>
                      </td>
                    </tr>
